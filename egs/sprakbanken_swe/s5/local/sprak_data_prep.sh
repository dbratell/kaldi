...
if [ ! -d $dir/download/0467-1 ]; then
    mkdir -p $dir/download/0467-1
    ...
    rm $dir/download/sve.16khz.0467-1.tar.gz
fi

if [ ! -d $dir/download/0467-2 ]; then
    mkdir -p $dir/download/0467-2
    ...
    rm $dir/download/sve.16khz.0467-2.tar.gz
fi

# if [ ! -d $dir/download/0467-3 ]; then
#     mkdir -p $dir/download/0467-3
...
#     rm $dir/download/sve.16khz.0467-3.tar.gz
# fi
...
if [ ! -d $dir/download/0468 ]; then
    ...
    rm $dir/download/sve.16khz.0468.tar.gz
fi
...
mkdir -p $dir/corpus_processed/training/0467-1 $dir/corpus_processed/training/0467-2
...
# There is a weird sample with a space in it.
if [ -d $dir/corpus_processed/training/0467-1/'r4670118.791213 8232' ]; then
...
# These files might be outdated and validation scripts will get upset
# if it is so just remove and recreate it later.
for datadir in data/test data/train
do
    for file_to_delete in feats.scp cmvn.scp utt2dur wav.scp utt2num_frames
    do
        if [ -f $datadir/$file_to_delete ]; then
            rm $datadir/$file_to_delete
        fi
    done
done
...
#    cat $dir/corpus_processed/training/0467-1/txtlist $dir/corpus_processed/training/0467-2/txtlist $dir/corpus_processed/training/0467-3/txtlist | while read l; do cat $l; done > $lmdir/lmsents
    cat $dir/corpus_processed/training/0467-1/txtlist $dir/corpus_processed/training/0467-2/txtlist | while read l; do cat $l; done > $lmdir/lmsents
...
cat $dir/corpus_processed/training/0467-1/txtlist $dir/corpus_processed/training/0467-2/txtlist > $dir/traintxtfiles
cat $dir/corpus_processed/training/0467-1/sndlist $dir/corpus_processed/training/0467-2/sndlist > $dir/trainsndfiles
